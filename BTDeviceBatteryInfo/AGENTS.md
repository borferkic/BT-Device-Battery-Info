...
- Nombra las builds de revisión en `Builds` con versión y número consecutivo, sin palabras descriptivas: `0.20-dev1`, `0.20-dev2`, etc. La última versión publicada es `0.19`.
...
- En cada release, actualiza en `README.md` (inglés y español) la última versión, el enlace de descarga y las características generales de la app para reflejar lo implementado; esta actualización queda autorizada como parte de la release.
